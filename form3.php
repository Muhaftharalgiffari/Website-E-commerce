...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaran2` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    <h2>Catlo</h2>
                    <h4>Pouch\Kucing Dewasa</h4>
                    <h1>Rp55.000</h1>
                    <p>
                        <span></span>
                    </p>
                    <img class="product-img" src="https://cdn.royalcanin-weshare-online.io/lPkua2QBIYfdNSoCjv5b/v468/16-savour-exigent-b1-in" height="200px" width="150px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
            ...
            <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                ...
                <div class="owner-name">
                    <label>Total</label>
                    <input id="total" type="number" name="total" placeholder="55000" readonly />
                </div>
                <br><br>
        ...
        function calculateTotal() {
            var pricePerItem = 55000; // Harga per barang
