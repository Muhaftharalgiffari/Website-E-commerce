...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayarantoy2` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    ...
                    <img class="product-img" src="//www.absolutelyeverything.com.au/cdn/shop/files/DW-LACATRINA.jpg?v=1701641585&width=550 550w,//www.absolutelyeverything.com.au/cdn/shop/files/DW-LACATRINA.jpg?v=1701641585 600w" height="250px" width="250px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
            ...
            <div class="checkout-text">
                <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    ...
                    <div class="owner-name">
                        <label>Total</label>
                        <input id="total" type="number" name="total" placeholder="45000" readonly />
                    </div>
                    <br><br>
        ...
        <script>
            function calculateTotal() {
                var pricePerItem = 45000; // Harga per barang
