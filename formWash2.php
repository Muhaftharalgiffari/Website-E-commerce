...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaranWash1` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    ...
                    <img class="product-img" src="https://assets.petco.com/petco/image/upload/c_pad,dpr_1.0,f_auto,q_auto,h_636,w_636/c_pad,h_636,w_636/1090330-center-1" height="190px" width="200px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
            ...
            <div class="checkout-text">
                <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    ...
                    <div class="owner-name">
                        <label>Total</label>
                        <input id="total" type="number" name="total" placeholder="70000" readonly />
                    </div>
                    <br><br>
        ...
        <script>
            function calculateTotal() {
                var pricePerItem = 70000; // Harga per barang
