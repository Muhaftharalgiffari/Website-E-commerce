...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaranclothes2` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    <h2>Catlo</h2>
                    <h4>Pakaian Kucing</h4>
                    <h1>Rp100.000</h1>
                    <p>
                        <span></span>
                    </p>
                    <img class="product-img" src="https://m.media-amazon.com/images/W/MEDIAX_792452-T2/images/I/71J-wJWzOyL._AC_SL1500_.jpg" height="190px" width="200px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
            ...
            <div class="checkout-text">
                <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    <div class="back-to-home">
                        <a href="Clothes.php">Back to Clothe By Catlo</a>
                    ...
                    <div class="owner-name">
                        <label>Total</label>
                        <input id="total" type="number" name="total" placeholder="100000" readonly />
                    </div>
                    <br><br>
        ...
        <script>
            function calculateTotal() {
                var pricePerItem = 100000; // Harga per barang
