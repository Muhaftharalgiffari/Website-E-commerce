...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaran` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    <h2>Catlo</h2>
                    <h4>Pouch\Kucing Remaja</h4>
                    <h1>Rp50.000</h1>
                    <p>
                        <span></span>
                    </p>
                    <img class="product-img" src="https://cdn.royalcanin-weshare-online.io/9Gkua2QBG95Xk-RBh9KI/v556/16-indoor-27-b1-ne" height="200px" width="150px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
