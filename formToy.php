...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayarantoy` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    ...
                    <img class="product-img" src="//www.absolutelyeverything.com.au/cdn/shop/products/ZC513_936f1f7e-2ea2-4d28-83a7-9e75518a7bf4.jpg?v=1701015350&width=550 550w,//www.absolutelyeverything.com.au/cdn/shop/products/ZC513_936f1f7e-2ea2-4d28-83a7-9e75518a7bf4.jpg?v=1701015350&width=1100 1100w,//www.absolutelyeverything.com.au/cdn/shop/products/ZC513_936f1f7e-2ea2-4d28-83a7-9e75518a7bf4.jpg?v=1701015350&width=1445 1445w,//www.absolutelyeverything.com.au/cdn/shop/products/ZC513_936f1f7e-2ea2-4d28-83a7-9e75518a7bf4.jpg?v=1701015350 1500w" height="200px" width="150px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
            ...
            <div class="checkout-text">
                <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    ...
                    <div class="owner-name">
                        <label>Total</label>
                        <input id="total" type="number" name="total" placeholder="60000" readonly />
                    </div>
                    <br><br>
        ...
        <script>
            function calculateTotal() {
                var pricePerItem = 60000; // Harga per barang
