...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaranclothes1` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
        ...
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    ...
                    <img class="product-img" src="https://m.media-amazon.com/images/W/MEDIAX_792452-T2/images/I/71ZTPdUaaYL._AC_SL1500_.jpg" height="190px" width="200px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
