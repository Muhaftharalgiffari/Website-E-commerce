...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaranWash2` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    if ($hasil) {
        ...
        $message = "Pegiriman Akan di proses! Terima kasih, $name!";

        // Tambahkan script JavaScript untuk menampilkan notifikasi
        echo '<script>
                alert("Pengriman akan di proses! Terima kasih, ' . $name . '!");
              </script>';
    } else {
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    <h2>Catlo</h2>
                    <h4>Shampoo Kucing</h4>
                    <h1>Rp40.000</h1>
                    <p>
                        <span></span>
                    </p>
                    <img class="product-img" src="https://assets.petco.com/petco/image/upload/c_pad,dpr_1.0,f_auto,q_auto,h_636,w_636/c_pad,h_636,w_636/l_bypetco-badge,fl_relative,w_0.20,g_south_east,e_sharpen/3327877-center-1" height="190px" width="200px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
            ...
            <div class="checkout-text">
                <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    <div class="back-to-home">
                        <a href="wash.php">Back to Clothe By Catlo</a>
                    ...
                    <div class="owner-name">
                        <label>Total</label>
                        <input id="total" type="number" name="total" placeholder="40000" readonly />
                    </div>
                    <br><br>
        ...
        <script>
            function calculateTotal() {
                var pricePerItem = 40000; // Harga per barang
