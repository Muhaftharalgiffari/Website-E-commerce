...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaran1` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
    ...
    <div class="container">
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    <h2>Catlo</h2>
                    <h4>Pouch\Bayi Kucing dan Ibu Kucing</h4>
                    <h1>Rp60.000</h1>
                    <p>
                        <span></span>
                    </p>
                    <img class="product-img" src="https://cdn.royalcanin-weshare-online.io/BOcpdn8BaPOZra8q2dU7/v395/sol-mother-babycat-dry-packshot-b1" height="200px" width="150px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
            ...
            <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                <div class="back-to-home">
                    <a href="Food.php">Back to Food By Catlo</a>
