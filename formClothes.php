...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Contoh:
    $sql = "INSERT INTO `pembayaranclothes` (card_number, expiry_date, password, name, email, area, specific_address, quantity, total) 
        ...
        <div class="wrapper">
            <div class="checkout-image">
                <div class="info">
                    ...
                    <img class="product-img" src="https://m.media-amazon.com/images/W/MEDIAX_792452-T2/images/I/71wc+Gn4vJL._AC_UL320_.jpg" height="190px" width="200px" alt="Product-Image" />
                </div>
                <div class="footer">
                    <p>
